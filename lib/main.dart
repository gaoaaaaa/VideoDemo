import 'package:demoapp/homepage/homepage.dart';
...
import 'data_model/detail/VideoDetailModel.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      providers: [
        Provider<ThemeProvider>(create: (_) => ThemeProvider(LightTheme())),
//        Provider<NowPageProvider>(create: (_) => NowPageProvider()),
      ]
     ,
      child: MaterialApp(
        title: 'Flutter Demo',
        localizationsDelegates: [
          ...
          MyLocalizationDelegate.delegate
        ],
        supportedLocales: [
          Locale('zh', 'CH'),
        ],
